export const PropertyDetailsContentSection = () => {
  return (
    <div className="mt-8">
      ...
      <p className="mb-4">
        ...
        world. Please tell your friends about it. Thank you. Cloud bread kogi
        bitters pitchfork shoreditch tumblr yr succulents single-origin coffee
