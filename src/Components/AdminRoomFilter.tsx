...
import areaType from "../Enums/areaType.tsx";
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Column className="shadow-xl rounded-xl bg-orange-50 px-4 py-4 gap-8">
        ...
        <button
          type="submit"
          className="bg-orange-500 hover:bg-orange-600 h-10 rounded-xl text-white cursor-pointer flex items-center justify-center px-4 font-medium w-full sm:w-auto"
        >
          Search
        </button>
      </Column>
